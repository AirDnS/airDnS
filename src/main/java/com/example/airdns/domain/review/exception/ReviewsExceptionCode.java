...
public enum ReviewsExceptionCode {
    ...
    NOT_MODIFY_REVIEW(HttpStatus.UNAUTHORIZED, "REVIEWS-003", "해당 방에 대한 리뷰를 수정할 권한이 없습니다."),
    NOT_DELETE_REVIEW(HttpStatus.UNAUTHORIZED, "REVIEWS-004", "해당 방에 대한 리뷰를 삭제할 권한이 없습니다.");
